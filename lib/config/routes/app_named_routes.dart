...
class AppNamedRoutes {
  ...
  /// Choose Auth View
  static const String welcome = 'chooseAuth';
  ...
  static const String listCreatedSuccessfully = 'listCreatedSuccessfully';

  /// List Created Unsuccessfully View
  ///
  /// Use when the list's creation failed
  static const String listCreatedUnsuccessfully = 'listCreatedUnsuccessfully';
