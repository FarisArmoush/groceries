...
part of 'app_bottom_navigation_bar_item.dart';
...
class _$AppBottomNavigationBarItemImpl implements _AppBottomNavigationBarItem {
  ...
  @override
  String toString() {
    return 'AppBottomNavigationBarItem(title: $title, icon: $icon, selectedColor: $selectedColor, unselectedColor: $unselectedColor, activeIcon: $activeIcon)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, title, icon, selectedColor, unselectedColor, activeIcon);
...
abstract class _AppBottomNavigationBarItem
  ...
  factory _AppBottomNavigationBarItem(
